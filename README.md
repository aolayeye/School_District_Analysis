...
It is worth noting that by replacing with NaNs, pandas mean() method (Average Math Score and  Average Reading Score) ignored all records with NaN and focused only on numbers, as a result our average calculations remained unchanged.
